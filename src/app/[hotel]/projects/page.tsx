...
const getProjects = (prefix: string) => [
    {
        title: "Kannamundayil Residency",
        type: "Hospitality",
        icon: Building2,
        image: `/${prefix}-destination/kannamunda-main-building.webp`,
        status: "Operating",
    ...
    },
    {
        ...
        type: "Food & Beverage",
        icon: Briefcase,
        image: `/${prefix}-gallery/interior-room-image-edited.webp`,
        status: "Operating",
...
export default function ProjectsPage() {
    ...
    const projects = getProjects(hotel.imagePrefix);
        ...
        <div className="min-h-screen bg-neutral-950 text-white">
            ...
            <section ref={heroRef} className="relative h-[65vh] flex items-end overflow-hidden">
                <motion.div style={{ y: heroY }} className="absolute inset-0 z-0">
                    <Image src={`/${hotel.imagePrefix}-projects/projects-1.webp`} alt="Portfolio" fill className="object-cover object-bottom" priority />
