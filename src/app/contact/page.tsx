        ...
        <div className="min-h-screen bg-neutral-950 text-white">
            ...
            <section ref={heroRef} className="relative h-[65vh] flex items-end overflow-hidden">
                <motion.div style={{ y }} className="absolute inset-0 z-0">
                    <Image src="/contact/contact-us.jpg" alt="Contact Us" fill className="object-cover" style={{ objectPosition: "center 25%" }} priority />
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-white/70 text-xs font-light">
                                {formStatus === "success" ? "We have received your message." : "Please check your network or try again."}
                            </p>
                        </div>
                        <button
