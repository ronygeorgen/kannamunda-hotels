                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <RevealGroup>
                            ...
                            <motion.div variants={fadeUp} className="mb-16">
                                ...
                                <p className="text-lg md:text-xl text-gray-500 leading-relaxed font-light pl-4 md:pl-6 border-l border-primary/20 italic">
                            ...
                            <motion.div variants={fadeUp}>
                                ...
                                <div className="text-gray-500 text-base md:text-lg leading-relaxed font-light space-y-5 pl-4 md:pl-6 border-l border-primary/20">
            ...
            <section className="bg-gray-50 py-20 md:py-32 border-t border-gray-100 overflow-hidden">
                <div className="container px-6 max-w-5xl mx-auto">
                    <Reveal variants={fadeUp} className="mb-12 md:mb-16 text-center">
                        <p className="text-primary uppercase tracking-[0.25em] text-sm mb-3">Leadership</p>
                    ...
                    <RevealGroup className="flex flex-col md:flex-row gap-16 items-center">
                        ...
                        <div>
                            <motion.div variants={fadeUp}>
                                ...
                                <p className="text-primary uppercase tracking-[0.2em] text-xs mb-8">Managing Director</p>
                            </motion.div>
                            <motion.div variants={fadeUp} className="text-gray-500 text-lg leading-relaxed font-light space-y-5 mb-10">
                            ...
                            <motion.div variants={fadeUp} className="flex flex-wrap gap-6">
                                {['Strategic Foresight', 'Exceptional Excellence', 'Innovative Leadership'].map((s, i) => (
                                    <div key={i} className="flex items-center gap-3 text-sm tracking-wide text-gray-500 uppercase">
